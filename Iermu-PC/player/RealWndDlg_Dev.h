...
#include "../MainDlg.h"
#include "ffplayer.h"
class CRealWndDlg_Dev : public SHostDialog
{
public:
    CRealWndDlg_Dev();
    ~CRealWndDlg_Dev(void);
private:
...
protected:
	...
	EVENT_MAP_BEGIN()
		...
		EVENT_NAME_COMMAND(L"search_link", deviceOnSwitchToPlayer)
	EVENT_MAP_END()
    //消息映射表
    BEGIN_MSG_MAP_EX(CRealWndDlg_Dev)
